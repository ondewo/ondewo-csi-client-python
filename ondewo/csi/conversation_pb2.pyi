...
class S2sStreamResponse(google___protobuf___message___Message):
    ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"detect_intent_response",b"detect_intent_response",u"synthetize_response",b"synthetize_response"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"detect_intent_response",b"detect_intent_response",u"synthetize_response",b"synthetize_response"]) -> None: ...
