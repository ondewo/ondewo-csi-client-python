...
class ControlMessage(google.protobuf.message.Message):
    ...
    @property
    def params(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ControlMessageServiceParameters]: ...
    def __init__(self,
        *,
        service : global___ControlMessageServiceName.V = ...,
        method : global___ControlMessageServiceMethod.V = ...,
        params : typing.Optional[typing.Iterable[global___ControlMessageServiceParameters]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["method",b"method","params",b"params","service",b"service"]) -> None: ...
