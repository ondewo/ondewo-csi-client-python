...
class ControlStreamResponse(google___protobuf___message___Message):
    ...
    class ControlStatus(builtin___int):
        ...
        def Name(cls, number: builtin___int) -> builtin___str: ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'ControlStreamResponse.ControlStatus': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['ControlStreamResponse.ControlStatus']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'ControlStreamResponse.ControlStatus']]: ...
        NORMAL_STREAM = typing___cast('ControlStreamResponse.ControlStatus', 0)
        EMERGENCY_STOP = typing___cast('ControlStreamResponse.ControlStatus', 1)
    NORMAL_STREAM = typing___cast('ControlStreamResponse.ControlStatus', 0)
    EMERGENCY_STOP = typing___cast('ControlStreamResponse.ControlStatus', 1)
    global___ControlStatus = ControlStatus

    control_status = ... # type: global___ControlStreamResponse.ControlStatus

    def __init__(self,
        *,
        control_status : typing___Optional[global___ControlStreamResponse.ControlStatus] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
