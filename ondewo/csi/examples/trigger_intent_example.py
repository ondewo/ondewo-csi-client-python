...
from ondewo.csi.conversation_pb2 import TriggerIntentRequest


def main():
    parser = argparse.ArgumentParser(description="Trigger intent example.")
    ...
    parser.add_argument("--intent-name", default="i.order.pizza")
    ...
    response: DetectIntentResponse = conversations_service.trigger_intent(
        request=TriggerIntentRequest(
